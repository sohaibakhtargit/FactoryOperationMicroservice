...
namespace FactoryOperation_AccessManagementService.FactoryOpsApp.Application.Interfaces.Services.TenantAdmin.TenantAdminDashboard
{
    public interface ITenantAdminDashboardService
    {
