...
namespace FactoryOperation_AccessManagementService.FactoryOpsApp.Infrastructure.Implementation.Repository.SuperAdmin.Configuration
{
    public class TenantMigrationRepository : ITenantMigrationRepository
    {
        ...
        //    ALTER TABLE ""PointAssignments"" 
        //    DROP CONSTRAINT IF EXISTS FK_PointAssignments_Team;

        //    -- Drop the existing TeamId column
        //    ALTER TABLE ""PointAssignments"" 
        //    DROP COLUMN ""TeamId"";

        //    -- Add the TeamId column back
        //    ALTER TABLE ""PointAssignments"" 
        //    ADD COLUMN ""TeamId"" INTEGER;

        //    -- Add the new foreign key constraint referencing FactoryTeams
        //    ALTER TABLE ""PointAssignments"" 
        //    ADD CONSTRAINT FK_PointAssignments_FactoryTeams 
        //    FOREIGN KEY (""TeamId"") REFERENCES ""FactoryTeams""(""TeamId"");
        //    ";

        /*private const string migrationSql = @"
             ALTER TABLE ""PointAssignments"" 
  DROP CONSTRAINT ""FK_PointAssignments_AssignedToUser"";
          ";*/
...
('Tenant Admin', true, false, NOW(), 1, NULL, NULL, NULL, NULL),
