...
public class FactoryOpsDBContext : DbContext
{
    ...
    public DbSet<FactorySubPermission> FactorySubPermission { get; set; }
    public DbSet<FactoryUserRoles> FactoryUserRoles { get; set; }
    public DbSet<FactoryRolePermissions> FactoryRolePermissions { get; set; }
    public DbSet<FactoryRoleSubPermissions> FactoryRoleSubPermissions { get; set; }
    ...
    public DbSet<NotificationsMapping> NotificationsMappings { get; set; }
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
       ...
       .HasConversion<string>();
        ...
        modelBuilder.Entity<WorkOrder>()
            .Property(x => x.WorkOrderType)
            .HasConversion<string>();

        modelBuilder.Entity<WorkOrder>()
            .Property(x => x.UpdateType)
            .HasConversion<string>();
////
        modelBuilder.Entity<WorkOrder>()
            .Property(w => w.Status)
