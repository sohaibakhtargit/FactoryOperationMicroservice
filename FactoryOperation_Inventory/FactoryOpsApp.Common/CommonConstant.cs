namespace FactoryOperation_Inventory.FactoryOpsApp.Common
{
    public class CommonConstant
    {
        ...
        public static class PurchaseRequisitionStatusMessage
        {
            ...
            public const string CreateSuccess = "Purchase requisition created successfully";
            public const string CreateFailed = "Error creating purchase requisition";
        }
