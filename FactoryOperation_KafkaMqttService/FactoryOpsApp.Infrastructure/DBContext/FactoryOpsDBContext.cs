...
namespace FactoryOperation_KafkaMqttService.FactoryOpsApp.Infrastructure.DBContext
{
    public class FactoryOpsDBContext : DbContext
    {
        ...
        // kafka, mqtt, bridge configuration
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
          ...
          .HasConversion<string>();
            ...
            modelBuilder.Entity<MasterNotification>()
              .Property(e => e.AdditionalData)
              .HasColumnType("jsonb");

            // Configure jsonb columns as string storage for migrations if necessary
            modelBuilder.Entity<KafkaConfigurations>().Property(e => e.ProducerConfig).HasColumnType("jsonb");
            modelBuilder.Entity<KafkaConfigurations>().Property(e => e.ConsumerConfig).HasColumnType("jsonb");
            modelBuilder.Entity<KafkaConfigurations>().Property(e => e.DlqConfig).HasColumnType("jsonb");
            modelBuilder.Entity<MqttConfigurations>().Property(e => e.LastWill).HasColumnType("jsonb");
