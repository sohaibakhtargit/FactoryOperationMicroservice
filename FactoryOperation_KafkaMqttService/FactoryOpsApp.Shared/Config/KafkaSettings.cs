namespace FactoryOperation_KafkaMqttService.FactoryOpsApp.Shared.Config
{
    ...
    public class KafkaSettings
    {
        ...
        public bool EnableKafkaToMqtt { get; set; } = true;
        public string? KafkaToMqttTopic { get; set; } = @"factoryops\.\d+\.devices\..+\.telemetry";
