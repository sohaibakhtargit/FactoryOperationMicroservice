namespace FactoryOperation_NotificationService.FactoryOpsApp.Common
{
    public class CommonConstant
    {
        ...
        public static class PurchaseRequisitionStatusMessage
        {
            ...
            public const string CreateSuccess = "Purchase Request created successfully";
            public const string CreateFailed = "Error creating purchase Request";
        }
